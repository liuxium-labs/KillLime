...
import (
	...
	"github.com/killlime/killlime/player/simulation"
...
// InputAcceptable returns true if the input is within the rate-limit KillLime has imposed for the player.
...
// TicksSinceKnockback returns the amount of ticks since knockback was last set.
...
func (mc *AuthoritativeMovementComponent) Sync() {
	...
	if !mc.mPlayer.PendingCorrectionACK {
		// Make sure all of the player's actor data is up-to-date with KillLime's prediction.
