...
import "github.com/killlime/killlime/player"
...
func Register(p *player.Player) {
	...
	p.RegisterDetection(New_BadPacketH(p))
	p.RegisterDetection(New_BadPacketI(p))
	p.RegisterDetection(New_BadPacketJ(p))
	p.RegisterDetection(New_BadPacketK(p))
	p.RegisterDetection(New_BadPacketL(p))
	p.RegisterDetection(New_BadPacketM(p))
	p.RegisterDetection(New_BadPacketN(p))
	p.RegisterDetection(New_BadPacketO(p))
	p.RegisterDetection(New_BadPacketP(p))
	p.RegisterDetection(New_BadPacketQ(p))
	...
	// phase detections
	p.RegisterDetection(New_PhaseA(p))
