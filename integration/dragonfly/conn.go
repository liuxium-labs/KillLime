...
// sessionConn adapts an KillLime player to Dragonfly's connection contract. It
...
// ClientCacheEnabled remains disabled because KillLime does not yet track the
