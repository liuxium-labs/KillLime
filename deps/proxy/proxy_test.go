...
func TestBackendStateTrackerClearsSpectrumTransferState(t *testing.T) {
	...
	tracker.handle(&packet.PlayerList{Entries: []protocol.PlayerListEntry{{UUID: entryID, ActionType: protocol.PlayerListActionAdd}}}, 27)
...
func TestBackendStateTrackerHonoursRemovalPackets(t *testing.T) {
	...
	tracker.handle(&packet.PlayerList{Entries: []protocol.PlayerListEntry{{UUID: entryID, ActionType: protocol.PlayerListActionAdd}}}, 1)
	tracker.handle(&packet.PlayerList{Entries: []protocol.PlayerListEntry{{UUID: entryID, ActionType: protocol.PlayerListActionRemove}}}, 1)
