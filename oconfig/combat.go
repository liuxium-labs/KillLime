...
type CombatOpts struct {
	// LeftCPSLimit is the maximum amount of clicks per second that KillLime will allow for the left click.
	LeftCPSLimit int64 `json:"left_cps_limit" comment:"The maximum amount of CPS that KillLime will allow for the left click."`
	// RightCPSLimit is the maximum amount of clicks per second that KillLime will allow for the right click (for placing blocks).
	RightCPSLimit int64 `json:"right_cps_limit" comment:"The maximum amount of CPS that KillLime will allow for the right click."`

	// LeftCPSLimitMobile is the maximum amount of clicks per second that KillLime will allow for the "left click" on mobile devices.
	LeftCPSLimitMobile int64 `json:"left_cps_limit_mobile" comment:"The maximum amount of CPS that KillLime will allow for the left click on mobile devices."`
	// RightCPSLimitMobile is the maximum amount of clicks per second that KillLime will allow for the "right click" on mobile devices.
	RightCPSLimitMobile int64 `json:"right_cps_limit_mobile" comment:"The maximum amount of CPS that KillLime will allow for the right click on mobile devices."`

	// MaximumAttackAngle is the maximum angle in degrees that KillLime will allow for an attack to be considered valid.
	MaximumAttackAngle float32 `json:"maximum_attack_angle" comment:"The maximum angle in degrees that KillLime will allow for an attack to be considered valid."`
	...
	EnableClientEntityTracking bool `json:"enable_client_entity_tracking" comment:"This option is used to enable KillLime's client-sided entity tracking to perfectly lag compensate for the client view of entities. If you want to enable reach detections, this should be enabled."`
	...
	AllowNonMobileTouch bool `json:"allow_non_mobile_touch" comment:"Should KillLime allow non-mobile players to use the touch input mode? It is recommended to keep this option disabled as it may allow for\ntiny combat gains from players spoofing their input mode to touch."`
	...
	DisableFullAuthoritative bool `json:"disable_full_authoritative" comment:"If true, attacks always forward to the remote server even if KillLime's validator rejects them.\nDetections still flag — they just no longer block hit registration. Default: false."`
